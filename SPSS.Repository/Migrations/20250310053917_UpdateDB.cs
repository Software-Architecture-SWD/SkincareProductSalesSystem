    ...
    public partial class UpdateDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Capicities", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Routines_SkinTypes_SkinTypeId",
                        column: x => x.SkinTypeId,
                        principalTable: "SkinTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "ProductCapicities",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    CapicityId = table.Column<int>(type: "int", nullable: false),
                    StockQuantity = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductCapicities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductCapicities_Capicities_CapicityId",
                        column: x => x.CapicityId,
                        principalTable: "Capicities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductCapicities_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductSkinTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductSkinTypes_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductSkinTypes_SkinTypes_SkinTypeId",
                        column: x => x.SkinTypeId,
                        principalTable: "SkinTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AnswerDetails_AnswerSheets_AnswerSheetId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoutinesProductLists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoutinesProductLists_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoutinesProductLists_Routines_RoutinesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnswerDetails_AnswerSheetId",
                table: "AnswerDetails",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCapicities_CapicityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSkinTypes_ProductId",
                table: "ProductSkinTypes",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductSkinTypes_SkinTypeId",
                table: "ProductSkinTypes",
                column: "SkinTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Routines_SkinTypeId",
                table: "Routines",
                column: "SkinTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_RoutinesProductLists_ProductId",
                table: "RoutinesProductLists",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_RoutinesProductLists_RoutinesId",
                table: "RoutinesProductLists",
                column: "RoutinesId");
